...
* **Smart codebase exploration**: Get instant insights about any part of your project. Gammacode understands your entire codebase structure and can integrate external data sources through [MCP](/en/docs/gammacode/mcp) connections to tools like Google Drive, Figma, and Slack.
...
* **Direct code manipulation**: Beyond suggestions, Gammacode actively modifies files, executes commands, and creates commits. Extend capabilities with [MCP](/en/docs/gammacode/mcp) to access design documents, manage tickets, or integrate with your custom toolchain.
...
<CardGroup>
  ...
  <Card title="Commands" icon="terminal" href="/en/docs/gammacode/cli-reference">
