...
<CardGroup cols={2}>
  ...
  <Card title="IDE Integration" icon="laptop" href="/en/docs/gammacode/ide-integrations">
    Use Gammacode with your favorite editor
  </Card>
</CardGroup>
...
* **Community**: Join our [Discord](https://discord.gg/gammacode) for tips and support
