...
<CardGroup cols={1}>
  <Card title="Gammacode Issue Hunters" icon="bug" href="/api-reference/introduction">
    **GitHub PR review automation**
    
    Configure GitHub Actions to enable automated PR reviews, code analysis, and issue fixes. Simply tag `/gc` or `/gammacode` in PR comments to trigger intelligent code reviews and bug fixes.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="API Documentation" icon="book" href="/api-reference/introduction">
    Integrate Gammacode into your existing tools
  </Card>
</CardGroup>
